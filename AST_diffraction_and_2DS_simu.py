...
def degrade_image(I, x, y, pixel_size, x_2DSpixel_size, y_2DSpixel_size):              
	...
	x_center_0_1 = x_center*pixel_len_decomp + pixel_len_decomp/2
	y_center_0_1 = y_center*pixel_len_decomp + pixel_len_decomp/2
...
def plot_diffraction_image(Z, I, x, y, I_2DS, x_2DS, y_2DS, y_2DSpixel_size):
	...
	with sns.axes_style("whitegrid", {'axes.edgecolor':'0.', 
		...
		ax.text(5, -0.2, 'Z = %.2f cm' % (Z/1e4), ha='center', va='center', 
...
# Configuration
l = 0.783 # wavelength (µm)
pixel_size = 1.1 # (µm) to compute diffraction with Angular Spectrum Theory
...
#####################################
# EXAMPLE WITH AN OPAQUE RECTANGULAR
# Parameters
rect_w = 200 # rectangle width (µm)
rect_l = 100 # rectangle length (µm)
Z = 20000 # distance Z (µm)
